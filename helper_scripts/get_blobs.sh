...
cd ${TARGET_DIR}
if [ ! -f ${BLOBS_ARCHIVE} ];
	curl -O https://code.fairphone.com/downloads/FP2/blobs/${BLOBS_ARCHIVE}.tgz
fi

echo e157b4d0f2e60e095ffec3ca9057847ce3a178220cc5611f8a6410aa6a9f736b ${BLOBS_ARCHIVE}.tgz | sha256sum -c
